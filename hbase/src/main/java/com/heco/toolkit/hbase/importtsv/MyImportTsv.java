 ...
 *
 * @see MyImportTsv#usage(String)
 */
@InterfaceAudience.Public
@InterfaceStability.Stable
public class MyImportTsv extends Configured implements Tool {

  protected static final Log LOG = LogFactory.getLog(MyImportTsv.class);
  ...
  final static Class DEFAULT_MAPPER = MyTsvImporterMapper.class;
          ...
          if (hfileOutPath != null) {
            ...
            if (mapperClass.equals(TsvImporterTextMapper.class)) {
              usage(TsvImporterTextMapper.class.toString()
                  ...
                  + MyTsvImporterMapper.class.toString()
  ...
  public int run(String[] args) throws Exception {
    ...
    synchronized (MyImportTsv.class) {
  ...
  public static void main(String[] args) throws Exception {
    int status = ToolRunner.run(new MyImportTsv(), args);
    System.exit(status);
  }
}